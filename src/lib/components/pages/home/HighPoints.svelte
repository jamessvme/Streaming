<div
	class="dark:bg-gray-900 dark:text-gray-500 flex flex-col items-center py-10 px-6 gap-5 bg-gray-100"
>
	<span class="dark:text-gray-100 text-4xl text-orange-500 font-bold">Why FLOGRAM?</span>
