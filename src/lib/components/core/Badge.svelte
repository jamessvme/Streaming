...
<div class={`inline-block whitespace-nowrap align-middle px-1 uppercase text-xs rounded-sm font-bold ${colorSchemeF} ${variantF}`} style={`font-size: ${fontSize} !important`}>
    <slot />
</div>